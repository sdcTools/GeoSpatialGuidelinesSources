...
\begin{table}[H]
    ...
    \begin{tabular}{|l|cc|c|  c  |l|cc|c|}
        ...
        8  & \textcolor{red}{1}  & \textcolor{red}{2}  & \textcolor{blue}{3}  &  & 8  & \cellcolor{lgrey}6  & \cellcolor{lgrey}- & \cellcolor{lgrey}6  \\
...
Geo-referenced data can be the basis for a variety of outputs. \emph{Microdata files} and \emph{aggregate tables} are the classical products of statistical offices.
